...
func (r *NodeScan) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &NodeScan{}).
		WithValidator(r).
		Complete()
}
...
var _ admission.Validator[*NodeScan] = &NodeScan{}

// ValidateCreate implements admission.Validator so a webhook will be registered for the type
func (r *NodeScan) ValidateCreate(ctx context.Context, obj *NodeScan) (admission.Warnings, error) {
	nodescanlog.Info("validate create", "name", obj.Name)

	allErrs := obj.validateNodeScan()
...
func (r *NodeScan) ValidateUpdate(ctx context.Context, oldObj, newObj *NodeScan) (admission.Warnings, error) {
	nodescanlog.Info("validate update", "name", newObj.Name)
	...
	allErrs = append(allErrs, newObj.validateNodeScan()...)
...
func (r *NodeScan) ValidateDelete(ctx context.Context, obj *NodeScan) (admission.Warnings, error) {
	nodescanlog.Info("validate delete", "name", obj.Name)
